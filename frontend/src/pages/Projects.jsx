  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50">
      ...
      <section className="relative bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900 text-white py-32 overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-cover bg-center opacity-10 bg-[url('https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')]"
        ></div>
        <div className="relative container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in-up">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">Projects</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
            Manage and download your configured projects with ease. Create, edit, and organize your custom product configurations.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4">
          {projectsLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 mb-8">Start creating your first project by configuring products.</p>
              <Link
                to="/products/ranges"
                className="inline-flex items-center bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {userProjects.map((project) => (
                <div
                  key={project.id}
                  className="bg-white rounded-2xl shadow-premium hover:shadow-lg overflow-hidden group transition-all duration-300"
                >
                    ...
                    {editingId === project.id ? (
                      <div className="mb-4 flex gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600"
                        >
                          ✓
                        </button>
                        <button
                    ...
                    {project.products?.length > 0 && (
                      <div className="space-y-3">
                        <button
                          ...
                          className="w-full bg-white border-2 border-green-200 text-green-700 hover:bg-green-50 font-semibold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
                        >
        ...
        <section className="py-20 bg-gradient-to-r from-green-900 to-emerald-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
              Configure more products and organize them into new projects.
            </p>
            <Link
              to="/products/ranges"
              className="inline-flex items-center bg-white hover:bg-green-50 text-green-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
              Create New Project
              <svg className="w-6 h-6 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
