...
import { apiService, getSolutionImageUrl } from "../services/api";
...
const Solutions = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      {/* Hero Section — theme aligned with Home (teal/cyan + green) */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-32 pb-32 md:pt-40 md:pb-40 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-25" />
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="#solutions" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-semibold rounded-lg transition-all shadow-lg hover:scale-105 transform">
      ...
      <section id="solutions" className="py-20 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          {/* Section Header — teal/cyan/green like Home */}
          ...
          {loading ? (
            <div className="text-center py-20">
              <div className="animate-spin rounded-full h-16 w-16 border-4 border-teal-600 border-t-transparent mx-auto mb-4" />
              <p className="text-gray-600 text-lg">Loading solutions…</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
              {solutions.map((solution, index) => {
                const imgSrc = getSolutionImageUrl(solution);
                let features = [];
                ...
                // Theme aligned with Home: teal, cyan, green
                const iconColors = [
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 md:p-7">
                      <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 group-hover:text-teal-600 transition-colors leading-tight">
                        {solution.title}
                      </h3>
      ...
      {/* CTA Section — teal/cyan/green like Home */}
      <section className="py-20 md:py-24 bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-teal-700 font-semibold rounded-lg transition-all">
