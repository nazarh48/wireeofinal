  ...
  const solutions = [
    {
      ...
      icon: "🏢",
      features: ["Centralized Control", "Energy Management", "Security Integration", "Remote Monitoring"],
    ...
    },
    {
      ...
      icon: "⚙️",
      features: ["Process Control", "Motor Protection", "Safety Systems", "Data Analytics"],
    ...
    },
    {
      ...
      icon: "⚡",
      features: ["Load Management", "Fault Protection", "Power Quality", "Grid Integration"],
    ...
    },
    {
      ...
      icon: "🌐",
      features: ["IoT Integration", "Cloud Connectivity", "Predictive Maintenance", "Real-time Analytics"],
    ...
    },
    {
      ...
      icon: "🔋",
      features: ["Consumption Monitoring", "Peak Load Management", "Renewable Integration", "Cost Optimization"],
    ...
    },
    {
      ...
      icon: "🛡️",
      features: ["Circuit Protection", "Emergency Systems", "Arc Fault Detection", "Ground Fault Protection"],
      image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl overflow-hidden group transition-all duration-300">
                ...
                <div className="p-8">
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    Learn More
                  </button>
                </div>
              </div>
