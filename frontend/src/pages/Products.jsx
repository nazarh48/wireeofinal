    ...
    <div className="min-h-screen bg-white">
              ...
              {(publicRanges || []).map((range, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-extrabold text-slate-900 mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-emerald-600 group-hover:to-teal-600 transition-all">
                        {range.name}
                      </h3>
          ...
          <div className="container mx-auto px-6 py-8">
            <div className="relative rounded-2xl overflow-hidden bg-slate-100 shadow-md">
              {selectedRange.image ? (
                ...
                <div className="w-full h-44 md:h-56 bg-gradient-to-br from-emerald-600 to-teal-700 flex items-center justify-center">
          ...
          <div className="container mx-auto px-6">
            ...
            {displaySimpleProducts.length > 12 && (
              <div className="text-center mt-10">
                <Link to="/products/browse" className="text-emerald-600 font-semibold hover:underline inline-flex items-center gap-1">
                  Browse all products
      ...
      {displayFeaturedProducts.length > 0 && (
        <section className="py-16 md:py-20 bg-gradient-to-b from-slate-50 to-white border-t border-slate-200">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 rounded-full text-sm font-semibold text-emerald-700 mb-4">
              ...
              {displayFeaturedProducts.map((product) => {
                ...
                return (
                  <div key={product.id} className="bg-white rounded-2xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden group transform hover:-translate-y-2">
                    ...
                    <div className="p-6">
                      <p className="text-sm text-emerald-600 font-bold mb-2 uppercase tracking-wider">{product.range?.name || 'Product'}</p>
                      <h3 className="text-xl font-extrabold text-slate-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-emerald-600 group-hover:to-teal-600 transition-all">{product.name}</h3>
